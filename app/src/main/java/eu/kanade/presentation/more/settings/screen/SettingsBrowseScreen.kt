...
object SettingsBrowseScreen : SearchableSettings {
    ...
    override fun getPreferences(): List<Preference> {
        ...
        return listOf(
            ...
            // HONDANA: no "NSFW content" switch. Hondana's sexual-content filter (hondana.safety) is
            // always on, and AdultContentGuard keeps showNsfwSource on so general sites that also
            // host some adult titles (MangaDex) aren't hidden with the adult-only ones.
        )
    }
}
